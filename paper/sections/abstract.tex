...
shift. Moreover, a single online pass over the data matches multi-epoch offline
training with an equal oracle budget on both source-task mastery and transfer
to an unseen domain, while requiring no task corpus in advance. These results
