...
Online SDFT is the only method that both updates weights and exploits a dense,
...
\textbf{Online SDFT (ours)} & \checkmark & \checkmark & verified self-output & per token \\
\bottomrule
\end{tabular}
\end{table}
